# Django settings for fixthecode project.
...
if ON_OPENSHIFT:
    ALLOWED_HOSTS = [
      socket.gethostname(), # For internal OpenShift load balancer security purposes.
...
if ON_OPENSHIFT:
    #imp.find_module('openshift.openshiftlibs')
...
ROOT_URLCONF = 'fixthecode.urls'

# Python dotted path to the WSGI application used by Django's runserver.
# WSGI_APPLICATION = 'fixthecode.wsgi.application'
